...
test("Get -> URL_GENRES, should return status code 200, and res.body to be defined and res.body.length = 1", async()=>{
...
test("Get -> URL_GENRES/:id, should return status code 200, and res.body to be defined and res.body.name = genre.name", async()=>{
    const res = await request(app)
...
test("Put -> URL_GENRES/:id, should return status code 201, and res.body to be defined", async()=>{
    const res = await request(app)
